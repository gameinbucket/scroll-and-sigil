...
#define CUBE_MODEL_FACE_VERTEX_COUNT (4 * CUBE_MODEL_STRIDE)
#define CUBE_MODEL_VERTEX_COUNT (6 * CUBE_MODEL_FACE_VERTEX_COUNT)
#define CUBE_MODEL_VERTEX_BYTES (CUBE_MODEL_VERTEX_COUNT * sizeof(float))
#define CUBE_MODEL_FACE_VERTEX_BYTES (CUBE_MODEL_FACE_VERTEX_COUNT * sizeof(float))

#define RENDER_CUBE_MODEL(x, y, z, i)                                                                                                                                                                  \
    {                                                                                                                                                                                                  \
        x, -y, -z, -1, -1, 1, 0, 0, i,       /* pos x 0 */                                                                                                                                             \
            x, y, -z, -1, -1, 1, 0, 0, i,    /* pos x 1 */                                                                                                                                             \
            x, y, z, -1, -1, 1, 0, 0, i,     /* pos x 2 */                                                                                                                                             \
            x, -y, z, -1, -1, 1, 0, 0, i,    /* pos x 3 */                                                                                                                                             \
            -x, -y, -z, -1, -1, -1, 0, 0, i, /* neg x 0 */                                                                                                                                             \
            -x, -y, z, -1, -1, -1, 0, 0, i,  /* neg x 1 */                                                                                                                                             \
            -x, y, z, -1, -1, -1, 0, 0, i,   /* neg x 2 */                                                                                                                                             \
            -x, y, -z, -1, -1, -1, 0, 0, i,  /* neg x 3 */                                                                                                                                             \
            -x, y, -z, -1, -1, 0, 1, 0, i,   /* pos y 0 */                                                                                                                                             \
            -x, y, z, -1, -1, 0, 1, 0, i,    /* pos y 1 */                                                                                                                                             \
            x, y, z, -1, -1, 0, 1, 0, i,     /* pos y 2 */                                                                                                                                             \
            x, y, -z, -1, -1, 0, 1, 0, i,    /* pos y 3 */                                                                                                                                             \
            -x, -y, -z, -1, -1, 0, -1, 0, i, /* neg y 0 */                                                                                                                                             \
            x, -y, -z, -1, -1, 0, -1, 0, i,  /* neg y 1 */                                                                                                                                             \
            x, -y, z, -1, -1, 0, -1, 0, i,   /* neg y 2 */                                                                                                                                             \
            -x, -y, z, -1, -1, 0, -1, 0, i,  /* neg y 3 */                                                                                                                                             \
            x, -y, z, -1, -1, 0, 0, 1, i,    /* pos z 0 */                                                                                                                                             \
            x, y, z, -1, -1, 0, 0, 1, i,     /* pos z 1 */                                                                                                                                             \
            -x, y, z, -1, -1, 0, 0, 1, i,    /* pos z 2 */                                                                                                                                             \
            -x, -y, z, -1, -1, 0, 0, 1, i,   /* pos z 3 */                                                                                                                                             \
            -x, -y, -z, -1, -1, 0, 0, -1, i, /* neg z 0 */                                                                                                                                             \
            -x, y, -z, -1, -1, 0, 0, -1, i,  /* neg z 1 */                                                                                                                                             \
            x, y, -z, -1, -1, 0, 0, -1, i,   /* neg z 2 */                                                                                                                                             \
            x, -y, -z, -1, -1, 0, 0, -1, i,  /* neg z 3 */                                                                                                                                             \
    }
