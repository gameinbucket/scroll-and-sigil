...
struct ssao_blur_shader *new_ssao_blur_shader(vulkan_state *vk_state, vulkan_base *vk_base, vulkan_offscreen_buffer *offscreen) {
    ...
    struct ssao_blur_shader *shader = safe_calloc(1, sizeof(struct ssao_blur_shader));
    ...
    shader->uniforms3 = new_vulkan_uniform_buffer(sizeof(struct uniform_ssao_blur));
    ...
    pipe_settings.fragment = "shaders/spv/ssao_blur.frag.spv";
